...
@description('Embedding model used by the Foundry IQ knowledge base to vectorize documents.')
...
// Foundry project used to organize agents, models, knowledge bases and data.
resource project 'Microsoft.CognitiveServices/accounts/projects@2025-06-01' = {
  ...
  properties: {
    ...
    description: 'Foundry IQ product-expert agent lab project (mslearn-ai-agents exercise 04).'
  }
}

// Chat model deployment the agent uses to reason.
...
// Embedding model deployment used by the knowledge base to vectorize documents.
// Serialized after the chat deployment because a Cognitive Services account
// cannot process two deployment operations concurrently.
