# Exercise 08 — Orchestrate a multi-agent solution

A sequential orchestration of summarizer, classifier, and action agents that process customer feedback, built with the **Microsoft Agent Framework**.

> **Official exercise:** [08-agent-framework-multi-agents.html](https://microsoftlearning.github.io/mslearn-ai-agents/Instructions/Exercises/08-agent-framework-multi-agents.html)
