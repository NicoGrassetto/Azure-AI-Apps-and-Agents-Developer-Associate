# Exercise 07 — Develop an agent with the Microsoft Agent Framework

An expense-processing agent built with the **Microsoft Agent Framework**, using a local data file as input.

> **Official exercise:** [07-agent-framework.html](https://microsoftlearning.github.io/mslearn-ai-agents/Instructions/Exercises/07-agent-framework.html)
...
cd src && python agent-framework.py
```
